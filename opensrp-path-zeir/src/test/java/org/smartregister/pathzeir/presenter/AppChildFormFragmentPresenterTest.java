...
public class AppChildFormFragmentPresenterTest extends BaseUnitTest {
    ...
    private final String outOfCatchmentMockJson = "{\n" +
            "  \"count\": \"1\",\n" +
    ...
    public void setUp() throws Exception {
        ...
        Whitebox.setInternalState(presenter, "mStepName", "step1");
    ...
    public void testOnCheckedChange() {
        ...
        Whitebox.setInternalState(presenter, "encounterType", "Out of Area Service");
