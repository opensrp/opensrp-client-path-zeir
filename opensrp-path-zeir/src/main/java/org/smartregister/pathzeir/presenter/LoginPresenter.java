...
import org.smartregister.pathzeir.interactor.LoginInteractor;
import org.smartregister.pathzeir.util.AppConstants;
import org.smartregister.pathzeir.util.ImageLoaderRequest;
...
public class LoginPresenter extends BaseLoginPresenter implements BaseLoginContract.Presenter {
    ...
    public void processViewCustomizations() {
        try {
            ...
            ViewConfiguration loginView = ZeirApplication.getJsonSpecHelper().getConfigurableView(jsonString);
