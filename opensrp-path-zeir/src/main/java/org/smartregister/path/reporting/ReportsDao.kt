...
import org.smartregister.path.reporting.ReportsDao.SqlQueries.DISTINCT_REPORT_MONTHS_SQL
...
import org.smartregister.path.reporting.annual.coverage.domain.VaccineCount
...
import java.util.*
import org.smartregister.path.reporting.annual.coverage.repository.VaccineCoverageTargetRepository.ColumnNames as CoverageTableColumns
import org.smartregister.path.reporting.indicatorposition.IndicatorPositionRepository.ColumnNames as IndicatorPositionTableColumns
import org.smartregister.path.reporting.monthly.MonthlyReportsRepository.ColumnNames as MonthlyRepositoryTableColumns
